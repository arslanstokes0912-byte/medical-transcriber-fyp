...
That's what we set out to build with **Healthaid Medical AI Transcriber**.
...
================================================================================
Generated by Healthaid Medical AI (https://transcriber.Healthaid.ai)
...
The Healthaid Medical AI Transcriber is open source and available to try:
...
This project is part of the Healthaid platform, building AI tools to improve healthcare workflows and reduce clinician burnout.

**Want to contribute?** Check out our GitHub repository and join the conversation.

**Questions or feedback?** Reach out at hello@Healthaid.ai
